  ...
  <main>
    ...
    <div class="myanime" v-if="my_anime.length > 0">
      ...
      <div v-for="anime in my_anime_asc" class="anime">
        ...
        <button @click="increaseWatch(anime)" v-if="anime.total_episodes !== anime.watched_episodes" class="button">
          +
        </button>
        <button @click="decreaseWatch(anime)" v-if="anime.watched_episodes > 0" class="button">
          -
        </button>
      </div>
    </div>
